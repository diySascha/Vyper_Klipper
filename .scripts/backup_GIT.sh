...
echo GIT Repo adress: https://github.com/diySascha/Vyper_Klipper
echo GIT Repo adress: https://github.com/diySascha/Vyper_Klipper >> /home/pi/printer_data/config/Backuplogs/git_ready.log
log_date=(`date +%Y-%m-%d_%H:%M:%S`)
